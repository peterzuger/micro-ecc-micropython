...
def digest(message, size=32):
    return sha256(message).digest()[:size]
...
class uECCTest(unittest.TestCase):
    ...
    def test_curve_size(self):
        ...
        curve_size_should = int(c.curve[4:7]) / 8
    ...
    def test_sign(self):
        ...
        for message in MESSAGES:
            ...
            message_hash = digest(message, c.curve_size)
